...
import {getAllUploadVideoAPI, getCategoryAPI, updateCategoryAPI, uploadvideoAPI} from '../services/allAPI'
...
function View() {
    ...
    <Row droppable='true' onDragOver={e=>dragOver(e)} onDrop={e=>videoDropped(e)}>
      {
        allVideos?.length>0?allVideos.map(video=>( <Col sm={12} md={4} lg={3}>
